            ...
            <div className="relative z-10 flex min-h-screen w-full">
                ...
                <div className="hidden w-[56%] flex-col justify-center px-16 py-12 lg:flex">
                    ...
                    <h1 className="mt-10 max-w-lg text-[2.75rem] leading-[1.15] font-black tracking-tight text-slate-900">
                        Let&apos;s set up your admin panel.
                    </h1>

                    {/* subtitle */}
                    <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-500">
                        Create your super admin account to get started. You&apos;ll have full control to manage admins, students, and platform settings.
                    </p>
                    ...
                    <div className="flex gap-10">
                        <div className="flex items-start gap-3">
                            <div className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-indigo-100">
                                <HiSparkles className="size-5 text-indigo-600" />
                            </div>
                            <div>
                                <p className="text-sm font-bold text-slate-800">One-time Setup</p>
                                <p className="text-xs leading-relaxed text-slate-500">Run once, secured forever</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-violet-100">
                                <HiShieldCheck className="size-5 text-violet-600" />
                            </div>
                            <div>
                                <p className="text-sm font-bold text-slate-800">Super Admin</p>
                                <p className="text-xs leading-relaxed text-slate-500">Full platform access</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-2xl ring-1 shadow-slate-200/80 ring-slate-100/80">
                        ...
                        <div className="mb-6 flex items-center justify-between">
                            <div className="flex items-center gap-2 rounded-full bg-indigo-50 px-3.5 py-1.5 ring-1 ring-indigo-100">
                                <HiSparkles className="size-3.5 text-indigo-500" />
                                <span className="text-xs font-semibold text-indigo-600">Initial Setup</span>
                            </div>
                            <div className="size-2.5 rounded-full bg-emerald-500" />
                        </div>

                        {/* heading */}
                        <h2 className="text-2xl font-extrabold text-slate-900">Create super admin</h2>
                        <p className="mt-1 text-sm text-slate-400">This account will have full control of the platform.</p>
                        ...
                        <form className="mt-6 flex flex-col gap-4" onSubmit={handleSubmit}>
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pr-3 pl-10 text-sm text-slate-800 transition outline-none placeholder:text-slate-300 focus:border-indigo-400 focus:bg-white focus:ring-3 focus:ring-indigo-100"
                                        />
                                    </div>
                                </div>
                                <div className="flex-1">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3 text-sm text-slate-800 transition outline-none placeholder:text-slate-300 focus:border-indigo-400 focus:bg-white focus:ring-3 focus:ring-indigo-100"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        {showPassword ? <HiEyeSlash className="size-4" /> : <HiEye className="size-4" />}
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="my-5 flex items-center gap-3">
                            ...
                            <span className="text-xs text-slate-300">one-time only</span>
                            <div className="h-px flex-1 bg-slate-100" />
                        </div>

                        <p className="text-center text-xs text-slate-400">
                            This page is only available before the first admin is created.
                        </p>
                    </div>
